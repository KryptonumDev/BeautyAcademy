...
const Team = ({ team_Heading, team_List, team_Paragraph, team_Cta }) => {
  return (
    <section className={styles.wrapper}>
      ...
      <div className={styles.list}>
        {team_List.map(
          (
            { img, name, paragraph, partnership_Title, partnership_List },
            i
          ) => (
                    ...
                    <div className={styles.partnership}>
                      ...
                      <div className={styles.wrapper}>
                        {partnership_List.map(({ title, img }, i) => {
                          const markdownTitle = <Markdown>{title}</Markdown>
                          return (
                            <PartnershipItem
                              {...{ title, img }}
                              key={i}
