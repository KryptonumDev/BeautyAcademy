  ...
  return (
    <div className={styles.item}>
      ...
      <div className={styles.cart}>
        <AddToCart alreadyBought={alreadyBought} quantity="1" product={data}>
          {alreadyBought ? "Курс уже куплен" : "В корзину"}
        </AddToCart>
      </div>
    </div>
  );
